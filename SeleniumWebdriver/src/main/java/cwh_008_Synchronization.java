...
public class cwh_008_Synchronization {
    ...
    public static void loginPage(WebDriver driver, String userName, String password, WebDriverWait wait, WebElement element, String[] items) throws InterruptedException {
        int j = 0;
